...
-- NOTE: post-processed by extract.sh after aeneas ran: 3 site(s) patched for the le.default codegen bug, each marked inline. Not pure aeneas output.
-- [zkcash]: function definitions
import Aeneas
import code_model.generated.Types
import code_model.generated.FunsExternal
...
/-- Trait implementation: [zkcash::fr_shim::{impl core::cmp::PartialOrd<zkcash::fr_shim::FrShim> for zkcash::fr_shim::FrShim}]
    Source: 'programs/zkcash/src/fr_shim.rs', lines 39:0-41:1 -/
@[reducible]
      ...
      then
        let b ←
          core.cmp.PartialOrd.le.default
            fr_shim.FrShim.Insts.CoreCmpPartialOrdFrShim.partial_cmp /- PATCHED by extract.sh: aeneas le.default bug, see extract.sh -/ ext_amount_fr fee_fr
        if b
        then ok false
        else
